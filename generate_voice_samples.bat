...
for %%S in (Jon Gary Mike Will Patrick Eric Rick) do (
    ...
    python .\args_voice.py ^
        ...
        -d "%%S is a friendly, down-to-earth narrator in his mid-thirties with a relaxed, conversational American accent. He speaks at a steady, medium pace with a warm, approachable tone and just a hint of excitement. His voice feels close-up and personal, as though he's speaking directly to a friend. He enunciates clearly, but there’s an informal and slightly playful quality to his words, making him sound relatable and genuine." ^
        -p "Hello there! My name is %%S, and I’m excited to meet you all. The quick brown fox jumps over the lazy dog at sunrise, setting the stage for a marvelous day. Would you like to join me for coffee at 10 A.M. tomorrow?” ^
        -o ".\%%S.wav" ^
        -f default ^
        -v
)
